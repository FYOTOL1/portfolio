...
const ProjectCard = ({
  ...
  return (
    <>
      <div className="flex flex-col items-center gap-2 bg-main-100 w-1/2 md:w-1/3 h-60 shadow-main-200 shadow-lg p-5 pb-3">
...
const LastProjects = () => {
  ...
  return (
    <>
      <div className="w-full bg-main-100 py-20">
